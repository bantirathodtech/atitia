...
class CredentialStorageHelper {
  ...
  Future<Map<String, bool>> storeAllGoogleCredentials({
    ...
    if (androidClientId != null) {
      results['android_client_id'] = await storeGoogleAndroidClientId(androidClientId);
    }
  ...
  bool _isValidClientId(String clientId) {
    ...
    if (clientId.contains('YOUR_') || clientId.contains('REPLACE_WITH')) return false;
  ...
  bool _isValidClientSecret(String clientSecret) {
    ...
    if (clientSecret.contains('YOUR_') || clientSecret.contains('REPLACE_WITH')) return false;
