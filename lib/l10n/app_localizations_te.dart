...
class AppLocalizationsTe extends AppLocalizations {
  ...
  @override
  String get privacyPolicyLastUpdatedDate => 'నవంబర్ 11, 2025';

  @override
  String privacyPolicyHostedNotice(String url) {
    return 'తాజా వెర్షన్‌ను ఆన్‌లైన్‌లో $url వద్ద చూడవచ్చు.';
  }

  @override
  String get privacyPolicyViewOnlineButton =>
      'గోప్యతా విధానం వెబ్‌సైట్ తెరవండి';

  @override
  String get privacyPolicyOpenLinkError =>
      'గోప్యతా విధానాన్ని తెరవడం సాధ్యపడలేదు. దయచేసి తరువాత ప్రయత్నించండి.';
  ...
  String get privacyPolicySection1Content =>
      'మేము మీరు మాకు నేరుగా అందించే సమాచారాన్ని సేకరిస్తాము, అందులో ఇవి ఉన్నాయి:\n• ఖాతా వివరాలు (పేరు, ఇమెయిల్ చిరునామా, ప్రొఫైల్ ఫోటో లేదా ఇతర గుర్తింపు వివరాలు)\n• మద్దతు సందేశాలు, ఫీడ్‌బ్యాక్, సర్వే సమాధానాలు వంటి కమ్యూనికేషన్లు\n• మీరు పంచుకునే కంటెంట్, అప్లోడ్‌లు, మీడియా, యాప్‌లోని ఇన్‌పుట్లు\n• ప్రత్యేక ఫీచర్‌కు మీరు స్పష్టంగా సమ్మతించినప్పుడు మాత్రమే అందించే సున్నితమైన డేటా';
  ...
  String get privacyPolicySection2Content =>
      'మేము సేకరించిన సమాచారాన్ని ఈ విధంగా ఉపయోగిస్తాము:\n• సేవలను అందించడానికి, నిర్వహించడానికి, నిర్వహించడానికి మరియు మెరుగుపరచడానికి\n• మీ అనుభవాన్ని వ్యక్తిగతీకరించి సంబంధిత కంటెంట్‌ను అందించడానికి\n• ఖాతా సృష్టి, ప్రామాణీకరణ మరియు మద్దతును నిర్వహించడానికి\n• వినియోగ ధోరణులను విశ్లేషించి, సమస్యలను గుర్తించి, సేవ స్థిరత్వాన్ని నిర్ధారించడానికి\n• సేవ ప్రకటనలు, భద్రతా అలెర్ట్‌లు మరియు నవీకరణలను పంపడానికి\n• మా నిబంధనలను అమలు చేసి, దుర్వినియోగాన్ని నిరోధించి, చట్టపరమైన బాధ్యతలను నెరవేర్చడానికి';
  ...
  String get privacyPolicySection3Content =>
      'మేము మీ వ్యక్తిగత 데이터를 అవసరం ఉన్నప్పుడే పంచుకుంటాము:\n• హోస్టింగ్, విశ్లేషణ, చెల్లింపులు లేదా భద్రతకు మద్దతు ఇస్తున్న మరియు గోప్యతా ఒప్పందాలకు లోబడి ఉండే సర్వీస్ ప్రొవైడర్‌లతో\n• వర్తించే చట్టాలు, నియమాలు లేదా చట్టపరమైన అభ్యర్థనలను నెరవేర్చడానికి\n• విలీనాలు, కొనుగోళ్లు లేదా ఆస్తి అమ్మకాల వంటి వ్యాపార బదిలీల సమయంలో\n• మీ సమ్మతి లేదా మీ సూచన మేరకు';
  ...
  String get privacyPolicySection4Content =>
      'మీ డేటాను రక్షించడానికి మేము సాంకేతిక మరియు సంస్థాగత భద్రతా చర్యలను—ప్రసార సమయంలో ఎన్క్రిప్షన్, సురక్షిత నిల్వ, యాక్సెస్ నియంత్రణలు మరియు సాధారణ సమీక్షలను—అమలు చేస్తాము. అయినప్పటికీ, ఏ వ్యవస్థ కూడా పూర్తిగా భద్రంగా ఉండదు, కాబట్టి బలమైన సంకేతపదాలను ఉపయోగించి అనుమానాస్పద కార్యకలాపాలను మాకు తెలియజేయమని మేము కోరుతున్నాము.';
  ...
  String get privacyPolicySection5Content =>
      'మీకు ఈ హక్కులు ఉన్నాయి:\n• మేము కలిగి ఉన్న సమాచారాన్ని యాక్సెస్ చేయడం లేదా కాపీని అభ్యర్థించడం\n• తప్పుగా ఉన్న డేటాను నవీకరించడం లేదా సరిచేయడం\n• చట్టపరమైన నిల్వ అవసరాలకు లోబడి మీ డేటాను తొలగించాలని అభ్యర్థించడం\n• ఐచ్చిక డేటా ప్రాసెసింగ్‌కు ఇచ్చిన సమ్మతిని ఉపసంహరించుకోవడం\n• ప్రోమోషనల్ మరియు అవసరం లేని కమ్యూనికేషన్ల నుండి తప్పుకోవడం';
  ...
  String get privacyPolicySection6Content =>
      'ఈ గోప్యతా విధానం గురించి మీకు ప్రశ్నలు ఉంటే, దయచేసి మమ్మల్ని ఈ విధంగా సంప్రదించండి:\n\nఇమెయిల్: bantirathodtech@gmail.com\nచిరునామా: హైటెక్ సిటీ, హైదరాబాదు, తెలంగాణ, ఇండియా 500083';
