    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          AppRoutes.guestHome,
          reason: 'Guest should be redirected to guest dashboard when accessing owner route',
        );
        
        expect(
          RouteGuard.getRedirectPath(AppRoutes.ownerOverview, 'guest'),
          AppRoutes.guestHome,
          reason: 'Guest should be redirected to guest dashboard when accessing owner overview',
        );
        
        expect(
          RouteGuard.getRedirectPath(AppRoutes.ownerFoods, 'guest'),
          AppRoutes.guestHome,
          reason: 'Guest should be redirected to guest dashboard when accessing owner foods',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          AppRoutes.ownerHome,
          reason: 'Owner should be redirected to owner dashboard when accessing guest route',
        );
        
        expect(
          RouteGuard.getRedirectPath(AppRoutes.guestPGs, 'owner'),
          AppRoutes.ownerHome,
          reason: 'Owner should be redirected to owner dashboard when accessing guest PGs',
        );
        
        expect(
          RouteGuard.getRedirectPath(AppRoutes.guestPayments, 'owner'),
          AppRoutes.ownerHome,
          reason: 'Owner should be redirected to owner dashboard when accessing guest payments',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          AppRoutes.splash,
          reason: 'Unauthenticated user should be redirected to splash when accessing guest route',
        );
        ...
        expect(
          ...
          AppRoutes.splash,
          reason: 'Unauthenticated user should be redirected to splash when accessing owner route',
        );
        ...
        expect(
          ...
          isNull,
          reason: 'Phone auth route should be accessible without authentication',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          isNull,
          reason: 'Authenticated guest should be able to access guest dashboard',
        );
        ...
        expect(
          ...
          isNull,
          reason: 'Authenticated guest should be able to access guest complaints',
        );
      },
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          ...
          isNull,
          reason: 'Authenticated owner should be able to access owner dashboard',
        );
